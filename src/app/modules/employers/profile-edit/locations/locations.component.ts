...
import { EditLocationModalComponent } from './edit-location/edit-location.component';
...
export class LocationsComponent
  ...
  constructor(
    ...
    public thisService: EmployerLocationService
  ) {}

  ngOnInit(): void {

  let userId =localStorage.getItem('userId');
    this.endpoint=`getEmployerLocations?adminId=${userId}&employerId=${this.employerProfileId}`
    this.searchForm();
  ...
  */
  ...
  let userId =localStorage.getItem('userId');
    this.endpoint=`deleteEmployerLocation?adminId=${userId}&employerLocationId=${id}&employerId=${this.employerProfileId}`
...
this.ngOnInit();
  ...
  edit(id): void {
    console.log("idr call ai..")
    const modalRef = this.modalService.open(EditLocationModalComponent, { size: 'lg' });
    modalRef.componentInstance.id = id;
